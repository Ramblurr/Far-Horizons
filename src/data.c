...
static global_cluster_t *unmarshalCluster(json_value_t *j);

static global_colony_t *unmarshalColony(json_value_t *j);

static global_colony_t **unmarshalColonies(json_value_t *j);

static global_data_t *unmarshalData(json_value_t *j);

static global_item_t **unmarshalInventory(json_value_t *j);

static global_location_t *unmarshalLocation(json_value_t *j);

static global_planet_t *unmarshalPlanet(json_value_t *j);

static global_planet_t **unmarshalPlanets(json_value_t *j);

static global_ship_t *unmarshalShip(json_value_t *j);

static global_ship_t **unmarshalShips(json_value_t *j);

static global_species_t *unmarshalSpecie(json_value_t *j);

static global_species_t **unmarshalSpecies(json_value_t *j);

static global_system_t *unmarshalSystem(json_value_t *j);

static global_system_t **unmarshalSystems(json_value_t *j);
